...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","SCSE","SCAI","SECE")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","Btech","BSC","MTECH","INT.MTECH")
        cou_combo.current(0)
        ...
        year_combo["values"]=("Select Year","2022-26","2022-27","2023-27","2023-28","2024-28")

...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        # backgorund image 
        bg1=Image.open(r"C:\Users\Dell\OneDrive\Desktop\Face\Image_GUI\bg2.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"C:\Users\Dell\OneDrive\Desktop\Face\Image_GUI\f_det.jpg")
    ...
    def mark_attendance(self, i, r, n):
     with open("attendance.csv", "r+", newline="\n") as f:
        ...
        for line in myDatalist:
            entry = line.split(",")  # Corrected split function
